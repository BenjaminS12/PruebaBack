    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('LIDER', 'Líder'), ('GENERAL', 'General')], default='GENERAL', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asignatura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appA.asignatura')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appA.usuario')),
            ],
        ),
    ]
